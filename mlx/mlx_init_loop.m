...
void *mlx_init()
{
  ...
  // load font
  new_mlx->font = mlx_new_image(new_mlx, (FONT_WIDTH+2)*95, FONT_WIDTH);
  i = 0;
  while (i < 4*(FONT_WIDTH+2)*95*FONT_WIDTH)
    {
  ...
  new_mlx->font->vertexes[5] = (-FONT_WIDTH-1)/1.4;
  new_mlx->font->vertexes[7] = (-FONT_WIDTH-1)/1.4;
#else
  new_mlx->font->vertexes[2] = FONT_WIDTH;
  new_mlx->font->vertexes[4] = FONT_WIDTH;
  new_mlx->font->vertexes[5] = -FONT_WIDTH-1;
  new_mlx->font->vertexes[7] = -FONT_WIDTH-1;
#endif
